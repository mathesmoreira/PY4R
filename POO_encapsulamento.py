...
class Conta:
    ...
    # não recebem um primeiro argumento especial (self)
    @staticmethod
    ...
    # ENCAPSULAMENTO
    # Usando um decorador para trabalhar com os métodos get e set,
    # ambos retorna o valor do attr privado
    @property
    def saldo(self):
        return self.__saldo
...
# Através dos decoradores, Property e .setter,
# podemos chamar os métodos como atributos públicos
...
# Mostrando que o atributo saldo foi renomeado
# na classe Conta para _Conta__saldo
