...
# Nome é o parametro obrigatorio para nossa func
dados_pessoais('Matheus')
dados_pessoais('Matheus', 25)
dados_pessoais(20)  # Python obedece ordem dos parametro, logo nome = 20
dados_pessoais('matheus', idade=20)  # Para poder passar a idade
...
# Variáveis mágicas: *args e**kwargs que permitem passar
# um num variável de argumentos *Args é geralmente usado
# qdo nao sabemos qtos arg tem a nossa funcao o "*" executa
# um empacotamento de dados para facilitar passagem de dados
