# Programa recebe valor de duas matrizes e calcula o produto entre elas

# Primeiro devemos saber se a quantidade de colunas na
# primeira matriz é igual ao de linhas da segunda
...
if mult_valida == 1:
    ...
    matriz2_colunas = int(input("Digite a quantidade de colunas da sua SEGUNDA matriz: "))
