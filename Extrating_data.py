...
for line in hand:
    ...
    # Acentuo circunflexo é utilizado para dar match, em nosso caso,
    # linhas que comecam com From:
    if re.search("^From:.+@", line):
        print(line)

# Procurando por strings com letras antes do @ e sem espaco,
# assim como depois deste.
