# Programa faz uma conexao ao server,  através de comandos da
# biblioteca socket, e salva a imagem em 'stuff.jpg'
import socket
...
fhand = open('stuff.jpg', 'wb')  # 'wb' writing in binary mode
fhand.write(picture)
fhand.close()
